...
interface Window {NUMKEYWORDS;}
Object.defineProperty(window, 'NUMKEYWORDS', { get: function () { return keyw.length; } });
...
/*static struct { uint32_t keyw; uint32_t date; }*/ var g_keywdate : keyword_t[] =
[
