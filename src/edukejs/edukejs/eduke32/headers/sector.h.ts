...
class map_t {
    partime: number; designertime: number;
    name: string; filename: string; musicfn: string;alt_musicfn: string;
    savedstate: mapstate_t;

    constructor() {
        this.partime=0; this.designertime=0;
        this.name=""; this.filename="";this. musicfn="";this.alt_musicfn="";
        this.savedstate=new mapstate_t();
    }
}
