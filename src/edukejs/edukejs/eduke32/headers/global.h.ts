...
//#pragma pack(pop)
var ProjectileData:projectile_t[];
var SpriteProjectile:projectile_t[];
function initProjectilesHack() {
    // trigger after projectile_t exists
    ProjectileData = newStructArray<projectile_t>(projectile_t, MAXTILES);
    SpriteProjectile = newStructArray<projectile_t>(projectile_t, MAXSPRITES);
}
