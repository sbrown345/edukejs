...
#define DEBUG_KRAND 1
#define DEBUG_MOSTS 1
#define DEBUG_POLY 0
#define DEBUG_DRAW_ROOMS 1
#define DEBUG_POLYMOST_DRAWALLS 1
#define DEBUG_POLYMOST_DRAWALLS_SCANSECTOR 1
#define DEBUG_POLYMOST_DRAWALLS_DOMOSTS_DETAIL 1
